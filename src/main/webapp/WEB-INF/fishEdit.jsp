...
<title>Edit a Fishing Location</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet" 
integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
</head>
<body class = "p-3">
	<div class="d-flex bd-highlight">
  		<div class="p-2 flex-grow-1 bd-highlight"><h1> Welcome to Edit a Fishing Location!</h1></div>
	...
	<img class = "p-2" src="/images/crappie.png" class="rounded float-start" alt="crappie">
	
	<form:form method="POST" action="/fish/${id}/edit" modelAttribute="editFish">
		<input type = "hidden" name="_method" value = "put">
		<form:input type="hidden" path="id"></form:input> 
		
			<table>
			<tr>
				<td><form:label path="fishSite">Fishing Site:</form:label></td>
				<td><form:input path="fishSite" class="input" /></td>				
			</tr>
			<tr>
			...
			<tr>
				<td><form:label path="speciespopulation">Species Population:</form:label></td>
				<td><form:input path="speciespopulation" class="textarea" /></td>				
			</tr>
			<tr>
				<td><form:label path="personalbest">Personal Best:</form:label></td>
				<td><form:input path="personalbest" class="input" /></td>				
			</tr>					
		</table>
		
		<form:hidden path ="user" value = "${userId}" />
		
		<input type="submit" value="Update Fishing site" class="button" />
	
	</form:form>
	
	<p>
		<form:errors path="fish.*"></form:errors>
	</p>
