...
<body class = "p-3">
	<div class="d-flex bd-highlight">
  		<div class="p-2 flex-grow-1 bd-highlight"><h1> Welcome to Add a Camp!</h1></div>
	...
	<img class = "p-2" src="/images/beartent.jpg" class="rounded float-start" alt="beartent">
	
	<form:form method="POST" action="/camps/new" modelAttribute="camp">
		<table>
			<tr>
		...
		<input type="submit" value="Create Camp" class="button" />
