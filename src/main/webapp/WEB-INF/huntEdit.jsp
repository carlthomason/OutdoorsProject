...
<title>Edit a Hunting Location</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet" 
integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
</head>
<body class = "p-3">
	<div class="d-flex bd-highlight">
  		<div class="p-2 flex-grow-1 bd-highlight"><h1> Welcome to Edit a Hunting Location!</h1></div>
	...
	<img class = "hunt" src="/images/buck3.jpg" class="rounded float-start" alt="buck">
	
	<form:form method="POST" action="/hunt/${id}/edit" modelAttribute="editHunt">
		<input type = "hidden" name="_method" value = "put">
		<form:input type="hidden" path="id"></form:input> 
		
			<table>
			<tr>
				<td><form:label path="huntSite">Hunting Site:</form:label></td>
				<td><form:input path="huntSite" class="input" /></td>				
			</tr>
			<tr>
			...
			<tr>
				<td><form:label path="species_population">Species Population:</form:label></td>
				<td><form:input path="species_population" class="textarea" /></td>				
			</tr>
			<tr>
				<td><form:label path="personal_best">Personal Best:</form:label></td>
				<td><form:input path="personal_best" class="input" /></td>				
			</tr>					
		</table>
		
		<form:hidden path ="user" value = "${userId}" />
		
		<input type="submit" value="Update Hunting site" class="button" />
	
	</form:form>
	
	<p>
		<form:errors path="hunt.*"></form:errors>
	</p>
