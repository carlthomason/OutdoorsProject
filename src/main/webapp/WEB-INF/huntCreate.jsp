...
<title>Add a Hunting Location</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet" 
integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
</head>
<body class = "p-3">
	<div class="d-flex bd-highlight">
  		<div class="p-2 flex-grow-1 bd-highlight"><h1> Welcome to Add a Hunting Location!</h1></div>
	...
	<img class = "p-2" src="/images/huntloc.jpg" class="rounded float-start" alt="buck">
	
	<form:form method="POST" action="/hunt/new" modelAttribute="hunt">
		...
		<input type="submit" value="Create a Hunting Site" class="button" />
